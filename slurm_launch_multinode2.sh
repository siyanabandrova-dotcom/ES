...
#SBATCH --nodes=2                 # Request 2 nodes (adjust as needed)
#SBATCH --gpus-per-task=4         # GPUs per node (adjust as needed)
#SBATCH --time=24:00:00            # Time limit hrs:min:sec
#SBATCH --output=/home/s5e/asims.s5e/Documents/esvllm-outer/hyperscale-es-vllm/logs/multinode2_%j.log
...
# Run with:
# sbatch $HOME/Documents/esvllm-outer/hyperscale-es-vllm/slurm_launch_multinode2.sh <sigma> <learning_rate> <max_tokens> <model_name> <population_size> <steps_per_adapter> <lora_r> <task> <normalize_with_std> <prompt_batch_size> <sub_dataset_size> <name_prefix>

# Example for 2 nodes with 4 GPUs each (population_size=128, 16 per GPU):
# sbatch $HOME/Documents/esvllm-outer/hyperscale-es-vllm/slurm_launch_multinode2.sh 0.001 0.001 4096 "Qwen/Qwen3-4B" 1024 1 4 "math2:deepscaler40k" "normalize-with-std" 16 "null" "multinode-test2"
# sbatch $HOME/Documents/esvllm-outer/hyperscale-es-vllm/slurm_launch_multinode2.sh 0.001 0.001 1024 "Qwen/Qwen3-0.6B" 128 1 4 "math2:deepscaler40k" "normalize-with-std" 16 "null" "multinode-test2"
